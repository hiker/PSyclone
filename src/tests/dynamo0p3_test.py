...
def test_field_fs():
    ...
    output = (
        ...
        "    IMPLICIT NONE\n"
        "    CONTAINS\n"
        "    SUBROUTINE invoke_0_testkern_fs_type(f1, f2, m1, m2, f3, f4, m3)\n"
        "      USE testkern_fs, ONLY: testkern_code\n"
        "      TYPE(field_type), intent(inout) :: f1, f2, m1, m2, f3, f4, m3\n"
        "      INTEGER, pointer :: map_w1(:) => null(), map_w2(:) => null(), map_w3(:) => null(), map_wtheta(:) => null(), map_w2h(:) => null(), "
        "map_w2v(:) => null()\n"
        "      INTEGER cell\n"
        "      INTEGER ndf_w1, undf_w1, ndf_w2, undf_w2, ndf_w3, undf_w3, "
        ...
        "        !\n"
        "        CALL testkern_code(nlayers, f1_proxy%data, f2_proxy%data, "
"m1_proxy%data, m2_proxy%data, f3_proxy%data, f4_proxy%data, m3_proxy%data, "
"ndf_w1, undf_w1, map_w1, ndf_w2, undf_w2, map_w2, ndf_w3, undf_w3, map_w3, "
"ndf_wtheta, undf_wtheta, map_wtheta, ndf_w2h, undf_w2h, map_w2h, ndf_w2v, "
"undf_w2v, map_w2v)\n"
        "      END DO \n"
        "      !\n"
...
def test_basis():
    ...
    output = (
        ...
        "op_2, field_3_w2, op_4_ncell_3d, op_4, field_5_wtheta, op_6_ncell_3d, "
        "op_6, field_7_w2v, ndf_w0, undf_w0, map_w0, basis_w0, ndf_w1, "
        "basis_w1, ndf_w2, undf_w2, map_w2, basis_w2, ndf_w3, basis_w3, "
        "ndf_wtheta, undf_wtheta, map_wtheta, basis_wtheta, ndf_w2h, "
        "basis_w2h, ndf_w2v, undf_w2v, map_w2v, basis_w2v, nqp_h, nqp_v, wh, "
        "wv)\n"
        "      USE constants_mod, ONLY: r_def\n"
        "      IMPLICIT NONE\n"
        "      INTEGER, intent(in) :: cell\n"
...
def test_diff_basis():
    ...
    output = (
        ...
        "    IMPLICIT NONE\n"
        "    CONTAINS\n"
        "    SUBROUTINE dummy_code(cell, nlayers, field_1_w0, op_2_ncell_3d, op_2, field_3_w2, op_4_ncell_3d, op_4, field_5_wtheta, op_6_ncell_3d, op_6, field_7_w2v, ndf_w0, undf_w0, map_w0, diff_basis_w0, ndf_w1, diff_basis_w1, ndf_w2, undf_w2, map_w2, diff_basis_w2, ndf_w3, diff_basis_w3, ndf_wtheta, undf_wtheta, map_wtheta, diff_basis_wtheta, ndf_w2h, diff_basis_w2h, ndf_w2v, undf_w2v, map_w2v, diff_basis_w2v, nqp_h, nqp_v, wh, wv)\n"
        "      USE constants_mod, ONLY: r_def\n"
        "      IMPLICIT NONE\n"
        "      INTEGER, intent(in) :: cell\n"
        "      INTEGER, intent(in) :: nlayers\n"
